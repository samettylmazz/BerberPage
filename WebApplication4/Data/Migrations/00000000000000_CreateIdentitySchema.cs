        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
               ...
               columns: table => new
               {
                  ...
                  Hizmet = table.Column<string>(maxLength: 256, nullable: true),
            ...
            migrationBuilder.CreateTable(
             ...
             constraints: table =>
             {
                 table.PrimaryKey("PK_RandevuAlma", x => new { x.UserId, x.RandevuId });
                 table.ForeignKey(
                     name: "FK_RandevuAlma_Randevu_RandevuId",
                     column: x => x.RandevuId,
                     principalTable: "Randevu",
                     principalColumn: "Id",
                     onDelete: ReferentialAction.Cascade);
                 table.ForeignKey(
                     name: "FK_RandevuAlma_AspNetUsers_UserId",
                     column: x => x.UserId,
